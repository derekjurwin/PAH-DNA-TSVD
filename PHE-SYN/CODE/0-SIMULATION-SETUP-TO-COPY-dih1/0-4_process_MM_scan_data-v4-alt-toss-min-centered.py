...
for i in all_scan_points_sorted_by_angles:
    ...
    shifted_diff_pot.append(i[1][2]-i[1][1])
    shifted_diff_pot_squared.append((i[1][2]-i[1][1])*(i[1][2]-i[1][1]))

shifted_diff_pot_squared_avg=sum(shifted_diff_pot_squared)/len(shifted_diff_pot_squared)

RMSE=math.sqrt(shifted_diff_pot_squared_avg)
...
image_name_string='0_19_QM_MM_PES_plot_diff_pot-min-centered'
for i in scan_points_to_toss_list:
    image_name_string=image_name_string+'-'
    image_name_string=image_name_string+str(i)

image_name_string=image_name_string+'-tossed-v4.png'

xtick_points=[-30,0,30,60,90,120,150,180,210,240,270,300,330]
xtick_labels=['-30','0','30','60','90','120','150','180','-150','-120','-90','-60','-30']
...
plt.plot(shifted_angles,shifted_diff_pot,"sb--",label='diff')
plt.legend(framealpha=1,frameon=True)
plt.xlabel('Dihedral Angle')
...
image_name_string='0_19_QM_MM_PES_plot_no_diff_pot-min-centered'
for i in scan_points_to_toss_list:
    image_name_string=image_name_string+'-'
    image_name_string=image_name_string+str(i)
...
image_name_string='0_19_QM_PES_plot_min-centered'
for i in scan_points_to_toss_list:
    image_name_string=image_name_string+'-'
    image_name_string=image_name_string+str(i)
