...
out_to_file1=open('0_10_matlab_sorted_angles_data-ALT.txt','w')
out_to_file2=open('0_11_matlab_diff_pot_data-ALT.txt','w')
...
image_name_string='0_12_QM_MM_PES_plot-ALT'
...
image_name_string='0_12_QM_MM_PES_plot_no_diff_pot-ALT'
for i in scan_points_to_toss_list:
    image_name_string=image_name_string+'-'
    image_name_string=image_name_string+str(i)
...
out_to_file=open('0_12_MM_calculated_dih_angles-ALT.txt','w')
